package data2.navigation 
{
	...
	public class Navigation 
	{
		...
		public static function gotoScreen(_idscreen:String):void
		{
			...
			//callback
			if (_listCallbackGoto[_idscreen] != undefined) {
				_listCallbackGoto[_idscreen]();
			}
			
			if (_listCallbackQuit[_curscreen] != undefined) {
		...
		public static function animate(__obj:*, _value:Boolean, _side:String, _d:Number, __distslide:Number = 700, _fade:Boolean = false, __timeAnim:Number = 0.6):void 
		{
			...
			if (_side == NavigationDef.ZOOM) {
				...
				var _effect:Function = (_value) ? Back.easeOut : Regular.easeOut;
				var _src:Number = (_value) ? 0 : 1;
				var _dst:Number = (!_value) ? 0 : 1;
				_twm.tween(_obj, "scaleX", _src, _dst, _timeanim, _d, _effect);
				_twm.tween(_obj, "scaleY", _src, _dst, _timeanim, _d, _effect);
			}
