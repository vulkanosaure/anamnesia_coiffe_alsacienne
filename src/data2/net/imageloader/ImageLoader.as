package data2.net.imageloader 
{
	...
	public class ImageLoader 
	{
		...
		public static function loadGroup(_group:String = ""):void
		{
			...
			trace("ImageLoader.loadItem(" + _idloading + ")");
			loadItem(_idloading);
		...
		*/
		...
		private static function onLoaderComplete(e:Event):void 
		{
			...
			var _evt:ImageLoaderEvent = new ImageLoaderEvent(ImageLoaderEvent.IMG_COMPLETE, _groupName);
			_evt.src = _obj.src;
			_evt.content = _obj.content;
		...
		{
			throw new Error("ImageLoader.onIOError " + e);
		}
