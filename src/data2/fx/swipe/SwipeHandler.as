package data2.fx.swipe 
{
	...
	public class SwipeHandler 
	{
		...
		public function init(_stage:Stage, _sp:Sprite, __width:Number):void
		{
			_container = _sp;
			_width = __width;
			_tabx = new Array();
		...
		private function onMouseUp(e:Event):void 
		{
			...
			if (_absmovementX > THRESHOLD_SWIPE_MOVEMENT || _absx > _width * THRESHOLD_SWIPE_PERCENT) {
				...
				/*
				var _time:Number = 0.2;
				_twm.tween(_container, "x", NaN, _endx, _time);
				var _nextstart:Number = (_bnext) ? -_width : +_width;
				
				DelayManager.add("", _time * 1000, function():void {
					
					_twm.tween(_container, "x", _nextstart, 0, 0.2);
				});
				*/
